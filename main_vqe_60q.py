...
if "SLURM_JOB_ID" in os.environ:
    str_date = str_date + "_" + os.environ["SLURM_JOB_ID"]
os.makedirs(str_date, exist_ok=True)
os.makedirs(str_date, exist_ok=True)

num_active_orbitals = 30
num_active_electrons = 21
spin = 1
basis = 'cc-pvdz'

num_max_layer = 20

jw_hamiltonian_file = f"fenta/ham_FeNTA_cc-pvdz_21e_30o.pickle"
...
MINIMIZE_METHODS = ['Powell', 'Nelder-Mead', 'CG', 'BFGS', 'L-BFGS-B', 'TNC', 'COBYLA', 'SLSQP']
